...
function introduction(){
	return {
		...
		stimulus: "<h1>N-Back Experiment</h1> \
			...
			same cell as <b>n</b> steps before. The difficulty levels will appear in a random order</p> \
...
function end_card(size, duration){
	return {
		...
		on_finish: function(data) {
			...
			// save the number of correctly answered trials
			data.correct = correct_trials;
		},
		data: {
			test_part: 'end_card'
		}
